 ...
 *
 * The orchestrator runs on a strict allowlist (its eleven tools plus Claude's
...
/** The orchestrator's complete allowlist: its eleven tools plus read-only built-ins. */
