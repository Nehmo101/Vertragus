...
export function buildOrchestratorSystemPrompt({
  ...
  return [
    ...
    '',
    'Your tools:',
    '- start_agent{role, task, model?, worktree?} — start a subagent. The task must be self-contained: goal, the files or area involved, the definition of done, and how to verify it. Set worktree: true only when an agent must work in isolation from the others.',
