...
import { mergeEvents } from './formatEvent'
        ...
        {workspace ? (
          <div className="tl-card">
            <WorkspaceCard
              ...
              showUsage
              bridge={bridge}
              onSaveAttachment={(target, source) => bridge!.saveAttachment(target, source)}
              onToggle={() => undefined}
              ...
              onAssignGoal={(id, goal) => bridge!.assignWorkspaceGoal(id, goal)}
              onAnswerQuestion={(id, agentId, questionId, text) =>
                bridge!.answerQuestion(id, agentId, questionId, text)
              }
              onUserMessage={(id, text, targetAgentId) =>
                bridge!.sendUserMessage(id, text, targetAgentId)
              }
